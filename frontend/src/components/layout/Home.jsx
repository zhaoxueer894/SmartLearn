            ...
            <div className="min-h-screen bg-gray-50">
                ...
                <div className="container py-12">
                        ...
                        {isLecturer ? (
                            <>
                                <Link to="/courses" className="card p-6 card-hover cursor-pointer block">
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <h3 className="text-xl font-semibold text-blue">Course Management</h3>
                                    </div>
                                ...
                                <div className="card p-6 card-hover cursor-pointer">
                                    <div className="flex items-center gap-3 mb-3">
                                        <span className="text-2xl">👥</span>
                                        <h3 className="text-xl font-semibold text-blue">Student Management</h3>
                                    </div>
                                ...
                                <Link to="/ai-tools" className="card p-6 card-hover cursor-pointer block">
                                    <div className="flex items-center gap-3 mb-3">
                                        <span className="text-2xl">🧠</span>
                                        <h3 className="text-xl font-semibold text-blue">AI Tools</h3>
                                    </div>
                                ...
                                <Link to="/word-cloud" className="card p-6 card-hover cursor-pointer block">
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <h3 className="text-xl font-semibold text-blue">Word Cloud Activities</h3>
                                    </div>
                            ...
                            <>
                                <Link to="/student/courses" className="card p-6 card-hover cursor-pointer block">
                                    <div className="flex items-center gap-3 mb-3">
                                        <span className="text-2xl">📖</span>
                                        <h3 className="text-xl font-semibold text-blue">My Courses</h3>
                                    </div>
                                ...
                                <div className="card p-6 card-hover cursor-pointer">
                                    <div className="flex items-center gap-3 mb-3">
                                        <span className="text-2xl">📝</span>
                                        <h3 className="text-xl font-semibold text-blue">Assignments</h3>
                                    </div>
                                ...
                                <Link to="/word-cloud" className="card p-6 card-hover cursor-pointer block">
                                    <div className="flex items-center gap-3 mb-3">
                                        <span className="text-2xl">💬</span>
                                        <h3 className="text-xl font-semibold text-blue">Interactive Activities</h3>
                                    </div>
                    ...
                    <div className="card p-4 max-w-md mx-auto mt-8">
                        <h4 className="font-semibold text-blue mb-2">Account Information</h4>
                ...
                <div className="container">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="card p-6 text-center card-hover">
                            <div className="w-12 h-12 bg-blue-light rounded-lg flex items-center justify-center mx-auto mb-4">
                            ...
                            <h3 className="text-xl font-semibold text-blue mb-2">Course Management</h3>
                        ...
                        <div className="card p-6 text-center card-hover">
                            ...
                            <h3 className="text-xl font-semibold text-blue mb-2">Interactive Quizzes</h3>
                            <p className="text-secondary">
                        ...
                        <div className="card p-6 text-center card-hover">
                            ...
                            <h3 className="text-xl font-semibold text-blue mb-2">AI-Powered Tools</h3>
                            <p className="text-secondary">
                        ...
                        <div className="card p-6 text-center card-hover">
                            ...
                            <h3 className="text-xl font-semibold text-blue mb-2">Student Engagement</h3>
                            <p className="text-secondary">
                        ...
                        <div className="card p-6 text-center card-hover">
                            ...
                            <h3 className="text-xl font-semibold text-blue mb-2">Analytics & Reports</h3>
                            <p className="text-secondary">
                        ...
                        <div className="card p-6 text-center card-hover">
                            ...
                            <h3 className="text-xl font-semibold text-blue mb-2">Word Cloud Activities</h3>
                            <p className="text-secondary">
